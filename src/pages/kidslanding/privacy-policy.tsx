...
function PrivacyPolicy(props: Props) {
  ...
  return (
    <div className={styles.pageContainer}>
      <Head>
        <title>Kid's Landing - Privacy Policy</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
      </Head>

      <strong>Privacy Policy</strong>
      <p>
        Samet Mutevelli built the Kid's Landing app as a Commercial app. This
        SERVICE is provided by Samet Mutevelli and is intended for use as is.
      </p>
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at Kid's Landing unless
      ...
      <p>This policy is effective as of 2023-03-16</p>
      <p>
        <strong>Contact Us</strong>
      </p>
      <p>
        If you have any questions or suggestions about my Privacy Policy, do not
        hesitate to contact me at sametmutevellioglu@gmail.com.
      </p>
    </div>
  );
}
